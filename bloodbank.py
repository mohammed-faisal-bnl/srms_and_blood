...
def admin_dashboard(admin_id):
    ...
    tk.Button(win, text="Approve Request",
              command=approve_request).pack(pady=10)        
       
# -------- MAIN MENU --------
tk.Button(root, text="Register Donor",
          command=register_donor).pack(pady=5)

tk.Button(root, text="Donor Login",
          command=donor_login).pack(pady=5)

tk.Button(root, text="Register Patient",
          command=register_patient).pack(pady=5)

tk.Button(root, text="Patient Login",
          command=patient_login).pack(pady=5)

tk.Button(root, text="Register Admin",
          command=register_admin).pack(pady=5)

tk.Button(root, text="Admin Login",
          command=admin_login).pack(pady=5)
